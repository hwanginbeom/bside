...
class EndpointEnumerator:
    ...
    def __init__(self, patterns=None, urlconf=None):
        if patterns is None:
            if urlconf is None:
                # Use the default Django URL config
    ...
    def get_api_endpoints(self, patterns=None, prefix=''):
        """
        Return a list of all available API endpoints by inspecting the URL config.
        """
        if patterns is None:
    ...
    def get_path_from_regex(self, path_regex):
        """
        Given a URL config regex, return a URI template string.
        """
