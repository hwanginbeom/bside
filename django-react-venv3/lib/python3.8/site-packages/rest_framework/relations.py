...
class HyperlinkedRelatedField(RelatedField):
    ...
    def get_object(self, view_name, view_args, view_kwargs):
        ...
        Takes the matched URL config arguments, and should return an
    ...
    def get_url(self, obj, view_name, request, format):
        ...
        attributes are not configured to correctly match the URL config.
        """
        ...
        try:
            ...
            if value in ('', None):
                ...
                msg += (
                    ...
                    "entries in your URL config." % value_string
                )
